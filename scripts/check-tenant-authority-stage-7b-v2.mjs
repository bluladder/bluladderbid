...
const reviewedPostRuntimeMigrations = new Set([
  ...
  // authenticated webhook-receipt lineage.
  "supabase/migrations/20260814113000_bluladder_klamath_phase_1i_crm_connector_lineage.sql",
  // Lovable-generated receipt for the exact Phase 1I payload, with only
  // terminal-LF normalization permitted by the Phase 1I checker.
  ...
  // Issue #151: review-only, fail-closed Klamath compliance-site lifecycle
...
const allowedEdgePaths = new Set([
  ...
  "supabase/functions/_shared/jobtreadExecutionRunner.ts",
  "supabase/functions/_shared/jobtreadExecutionRunner_test.ts",
  ...
  "supabase/functions/_shared/jobtreadReadPlanSource.ts",
