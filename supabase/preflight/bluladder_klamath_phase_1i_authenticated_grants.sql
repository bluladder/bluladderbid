-- Read-only preflight for the Phase 1I authenticated-role grant repair.
...
SELECT jsonb_build_object(
  'target_tables', (SELECT jsonb_agg(
    jsonb_build_object(
...
) AS phase_1i_grant_preflight
FROM role_grants, row_state, organization_state, klamath_state;
