...
3. adopt the prepared health/availability read-plan source and implement the
   protected customer/booking write-plan sources; authenticated webhook receipt
   processing remains future-only;
