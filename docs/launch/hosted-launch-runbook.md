...
| 1 | Repository freeze | 20m | Clean current main | Run full authoritative validation, secret scan, Oregon/campaign guards; hash outputs | Clean main and all repository gates pass | Any test/diff/security failure: cancel window | `REPOSITORY_READY` |
